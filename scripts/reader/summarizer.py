...
summarizer_agent = Agent(
    ...
    instruction=(
        ...
        "\n"
        "【一文形式】事実のみを伝える簡単なニュース記事の場合:\n"
        "人事発表・イベント告知・価格改定など、分析や解説を含まない事実報道が対象です。"
        "140文字以内の一文で要約してください。\n"
        "\n"
        "【箇条書き形式】以下のいずれかに該当する記事の場合:\n"
        "・新しいコンセプト・技術・知見を解説する記事（技術解説・チュートリアル・調査レポートなど）\n"
        "・重要なソフトウェアリリースや製品発表（新機能の詳細説明を含むもの）\n"
        "・分析・考察・意見を含む記事\n"
        "3〜5個の箇条書きで要約してください。"
